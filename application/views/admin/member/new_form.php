				...
				<div class="card-body">
					...
					<form action="<?php echo site_url('admin/member/add') ?>" method="post" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<input type="text" name="nama_member" class="form-control <?php echo form_error('nama_member') ? 'is-invailid':'' ?>">
						...
						<div class="form-group">
							...
							<textarea style="resize: none; width: 1030px; height: 100px;" name="deskripsi" class="form-control <?php echo form_error('deskripsi') ? 'is-invailid':'' ?>"></textarea>
							<div class="invalid-feedback">
